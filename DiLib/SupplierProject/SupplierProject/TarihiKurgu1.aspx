<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TarihiKurgu1.aspx.cs" Inherits="SupplierProject.TarihiKurgu1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">TARİHİ KURGU</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/Nutuk.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Nutuk</h2>
				  <h2>Mustafa Kemal ATATÜRK</h2>
                  <p>
                  Atatürk'ün yakın tarihimiz açısından büyük önem taşıyan ünlü eseri Nutuk, yıllar sonra Arap harflerinden bir kez daha çevrildi.
                      Uzun soluklu bu çeviri süreci, eserin 1934 baskısında var olan ve günümüze ulaşan çeşitli hataları da ortaya çıkardı.<br/>			  
                  </p>
