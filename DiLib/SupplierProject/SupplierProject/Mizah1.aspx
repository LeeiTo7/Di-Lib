<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mizah1.aspx.cs" Inherits="SupplierProject.Mizah1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">MİZAH</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/şçh_aziz.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Şimdiki Çocuklar Harika</h2>
				  <h2>Aziz Nesin</h2>
                  <p>
                      Zeynep ve ailesi babasının yeni işi yüzünden Ankara’ya taşınmıştır. Ahmet onun İstanbul’daki eski okulundan bir arkadaşıdır.
                      Kitap bu iki çocuğun birbirine yazdığı mektuplardan oluşmuştur.Zeynep Ahmet’e yeni evinden, 
                      okulundan bahseder.Ahmet de ona okullarına müfettiş geldiğinde neler olduğunu bahseder.
                      Zeynep daha sonra Ahmet’e babasının arkadaşlarının babalarıyla kavgasını,babasının ve ailesinin öğütlerini anlatır.
                      Ahmet’te ona yeni öğretmenini ve fedakarlık konusunda yazdığı yazıyı anlatır.
                     <br/>			  
                  </p>
