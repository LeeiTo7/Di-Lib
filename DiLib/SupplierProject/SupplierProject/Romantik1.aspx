<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Romantik1.aspx.cs" Inherits="SupplierProject.Romantik1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">ROMANTİK</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/sarah.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Paris’ten Çiçeklerle</h2>
				  <h2>Sarah Jio</h2>
                  <p>
                  1940’ların işgal altındaki Paris’inde Paris’in tüm çiçeklerini beklerken Paris’in tüm acılarını kendinde bulan bir kadın… 
                      2000’lerde Işığın Şehri Paris’in nostaljik havasında ve aydınlığında kendi acılarıyla ve geçmişiyle yüzleşebilmek için 
                      başka bir kadının geçmişinin peşinde iz süren başka bir kadın…<br/>			  
                  </p>
				 <div class="text-right p-t-136">
					<asp:Button ID="btnOkuma" class="btn btn-outline-success" href="Hata.aspx" runat="server" Text="Okumaya Başla" OnClick="btnOkuma_Click1" />
				 </div>
                </div>
              </div>  
            </div>			 			            			                         
