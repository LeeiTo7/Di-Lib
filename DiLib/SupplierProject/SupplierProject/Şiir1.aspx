<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Şiir1.aspx.cs" Inherits="SupplierProject.Şiir1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">ŞİİR</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/sevda.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Sevda Sözleri</h2>
				  <h2>Cemal Süreyya</h2>
                  <p>
                        Bir savaş: Otlukbeli<br/>	
                        Bir mavi: Spartaküs<br/>	
                        Bir soru: niçin Spartaküs<br/>	
                        Bir kuş: nereye gidiyon kuşu<br/>	
                        Bir çiçek: bilmem ki çiçeği<br/>	
                        Bir su: şüpheli<br/><br/>		

                        Bir belge: noterlerinden<br/>	
                        Elbet başkent noterlerinden<br/>	
                        Bir şair: Ahmed Arif...<br/>	                       	  
                  </p>
