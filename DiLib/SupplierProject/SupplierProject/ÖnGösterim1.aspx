<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ÖnGösterim1.aspx.cs" Inherits="SupplierProject.ÖnGösterim1" %>
...
<head runat="server">
    ...
    <title>Bir Adı Hazan Bir Adı Hüzün</title>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Bir Adı Hazan Bir Adı Hüzün</h1>
        </header>
          ...
          <div class="line">
             <div class="text-center p-t-136">
                 <p class="margin-bottom-30 text-size-20">
                    ...
                    Bütün güzellikleri talan eder<br/>
                    Sonra hiçbir şey olmamış gibi<br/>
                    Çekip gider<br/><br/>

                    Geriye, dalından koparılmış bir gül<br/>
                    Tarumar olmuş bir gönül<br/>
                    Siyaha âşık bir ruh bırakır. <br/><br/>

                    Vedalar da sonbahara dâhildir<br/>
                    Hiç başka bir mevsimde gördünüz mü? <br/>
                    Bir kelebeğin bir çiçeği terk ettiğini<br/>
                    Yahut ağaçların yapraklarına küstüğünü<br/><br/>

                    Ayrılıklar da çaresizlikler de <br/>
                    Bütün acı veren duygular da<br/>
                    Toplanmış gibidir<br/>
                    Bir adı hazan, <br/>
                    Bir adı hüzün olan bu mevsime... <br/><br/>

                    Bir kez daha kaybolduk <br/>
                    Sonbaharın girdabında<br/>
                    Yine darmadağın etti bizi<br/>
                    Yüreğimizi aydınlatmak kışa kaldı yine<br/>
                    Ve yeniden geldi, sonbaharın gitme vakti... <br/><br/>
                    Merve AKBAL<br/>
                </p>  
             </div>			                   
          </div>
