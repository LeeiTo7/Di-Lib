<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BilimKurgu1.aspx.cs" Inherits="SupplierProject.BilimKurgu1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">BİLİM KURGU</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/451.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Fahrenheit 451 </h2>
				  <h2>Ray Bradbury</h2>				  
                  <p>
                  İnsanlar neredeyse birbirleri ile olan iletişimlerini kopartığı,
                      kimsenin kimse ile konuşmadığı sadece ekranları izlediği bir dünyada yaşayan Gay Montag itfayeci olarak çalışmaktadır.
                      O zamanın dünyasında evler yanmadığı için itfayeciler yangın söndürmek yerine, kitap yakmak ile görevlidir.
                      Kitapta adını buradan alır kitapların tutuşma sıcaklığı  olarak bilinen Fahrenheit 451 dir. 
                      İtfaiye erlerinin bulunduğu büroya bir ihbar geldiği zaman Gay Montag ve ekibi hızlıca ihbarın geldiği yere gider
                      ve bulunan tüm kitapları yakmaktadırlar. Kahramanımız işini çok sevmekte ve yakma işinden çok zevk almaktadır..<br/>			  
                  </p>
