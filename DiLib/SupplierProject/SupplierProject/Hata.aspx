<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hata.aspx.cs" Inherits="SupplierProject.Hata" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">ÜZGÜNÜZ!</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">  
			<p class="margin-bottom-30 text-size-20">
				SİTEMİZE ÜYE OLMADAN BU İŞLEMİ GERÇEKLEŞTİREMEZSİNİZ. DEVAM ETMEK İÇİN KAYIT OLMAK İSTER MİSİNİZ?
            </p>
			<div class="text-center p-t-136">
                <asp:Button ID="btnKayıt" class="btn btn-outline-success" href="RegistrationPage.aspx" runat="server" Text="Kayıt Ol" OnClick="btnKayıt_Click" /> 				
			</div>				
          </div>
        </div> 
      </article>
