<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tümü.aspx.cs" Inherits="SupplierProject.Tümü" %>
              ...
              <div class="s-12 m-6 l-3">
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
						<div class="text-center p-t-12"></div>  
						<a href="Romantik.aspx">ROMANTİK</a>
                    </div> 
                  </div> 
              ...
              <div class="s-12 m-6 l-3">
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
						<div class="text-center p-t-12"></div> 
                        <a href="TarihiKurgu.aspx">TARİHİ KURGU</a>
                    </div> 
                  </div> 
              ...
              <div class="s-12 m-6 l-3">
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
						<div class="text-center p-t-12"></div>  
                        <a href="KısaHikaye.aspx">KISA HİKAYE</a>
                    </div> 
                  </div> 
              ...
              <div class="s-12 m-6 l-3">
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
						<div class="text-center p-t-12"></div>  
                        <a href="Fantastik.aspx">FANTASTİK</a>
                    </div> 
                  </div> 
              ...
              <div class="s-12 m-6 l-3">
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
						<div class="text-center p-t-12"></div>  
                        <a href="BilimKurgu.aspx">BİLİM KURGU</a>
                    </div> 
                  </div> 
