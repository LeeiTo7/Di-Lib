<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hikayelerim.aspx.cs" Inherits="SupplierProject.Hikayelerim" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">Hikayelerim</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/siyah kan.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
                  ...
                  Serbest dalış şampiyonu bir katil ile eski paparazzi, kötülük fikrine ve kaynağına takıntılı bir gazeteciyi karşı karşıya getiriyor. 
                      Katil hapiste… Ama daha önce Kamboçya, Tayland, Malezya’da kan dökmüş. Kadınların kanı… 
                      Gazetecinin onunla temasa geçmek için oynadığı oyun romanın temelini oluşturuyor. 
                      Ama katil bu yemi bir süre sonra yutmuyor. İşte gerçek heyecan da orada başlıyor. 
                      Kim av, kim avcı, birbirine karışıyor.<br/>			  
                  </p>
				 <div class="text-right p-t-136">
                     <asp:Button ID="btnHikaye" class="btn btn-outline-success" runat="server" Text="Hikayeyi Görüntüle" OnClick="btnHikaye_Click" /> 
                     <asp:Button ID="btnDeleteStory" class="btn btn-outline-success" runat="server" Text="Hikayeyi Sil" OnClick="btnDeleteStory_Click" />                    
				 </div>
                </div>
              </div>  
            </div>			 			            			                         
