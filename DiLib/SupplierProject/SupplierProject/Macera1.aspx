<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Macera1.aspx.cs" Inherits="SupplierProject.Macera1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">MACERA</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/başlangıç.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Başlangıç</h2>
				  <h2>Dan Brown</h2>
                  <p>
                      Dahi olan Edmond aynı zamanda çok ta zengin biridir. İnsanlığın başlangıcını bulduğunu iddia eder ve bunu bir sunumla tüm dünyaya duyuracaktır. 
                      Sunuma hocası olan Robet’i de davet eder. Sunum esnasında sahnede öldürülür. 
                      Robert kendini suçlu hisseder çünkü Edmond’dan cevapları daha önce alması gerekirdi. 
                      Edmond sunumdan olmadan bir kaç gün önce  büyük dinlerin temsilcileri ile görüşmüş ve kendi görüşünün tüm dinleri yok edeceğini anlatmıştır. 
                      Bunun üzerine çeşitli kesimlerden tehdit almıştır. Ölümünden sonra Robert sunumu kendisi yapmaya karar verir. Bu çok riskli bir iştir.
                      Çünkü tüm dinleri yıkacak olan bir buluş dünyada daha başka hangi konudan önemli olabilirdi ki?
                    <br/>			  
                  </p>
