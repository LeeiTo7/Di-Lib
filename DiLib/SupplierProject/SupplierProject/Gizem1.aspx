<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gizem1.aspx.cs" Inherits="SupplierProject.Gizem1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">GİZEM</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/kurt gölü.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Kurt Gölü</h2>
				  <h2>John Verdon</h2>
                  <p>
                  Ülkenin farklı yerlerinde yaşayan dört kişinin tek ortak noktası; aynı rüyayı gördüklerini ve bu rüyada kurt başlı 
                      bir hançerle öldürüldüklerini söylemiş olmalarıdır. Dördü de bu ifadelerinden hemen sonra, 
                      bilekleri kesilmiş halde bulunur ve yanı başlarında hepsini ölüme götüren kurt başlı bir hançer duruyordur.
                      Onları intihara götüren bu kabuslar mıydı?<br/>			  
                  </p>
