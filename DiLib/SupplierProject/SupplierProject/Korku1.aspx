<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Korku1.aspx.cs" Inherits="SupplierProject.Korku1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">KORKU</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/kafes.png" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Carol Gömülmeden</h2>
				  <h2>Josh Malerman</h2>
                  <p>
                      Carol Evers’ın karanlık bir sırrı vardı. Bazen komaya giriyor ve komaya girdiğinde bir ölüden farksız oluyordu. 
                      Nabzı ve kalbi duruyor, nefes aldığı belli olmasa da bilinci asla kapanmıyordu. Ancak doktorlar bile onun öldüğünü düşünüyordu.
                      Bu sırrı bilen iki kişiden biri olan ve ondan kurtulup servetine konmak isteyen kocası,
                      Carol komaya girdiğinde onu diri diri mezara gömmek için yaptığı planı hayata geçirmeye koyulur. 
                      Komadaki Carol çevresinde olan her şeyi duyup hissederken, Harrows adlı kasabada cenaze hazırlıkları başlar.
                      Bu sırrı bilen diğer kişi, Carol’ın eski sevgilisi, meşhur kanun kaçağı James Moxie ise haberi aldığında Carol gömülmeden Harrows’a yetişmek için yola çıkar.
                      Tehlike ve gizemle dolu yolda yolculuk ederken eski düşmanlarla, ürkütücü varlıklarla ve peşindeki kiralık katillerle başa çıkmak zorundadır.
                  <br/>			  
                  </p>
