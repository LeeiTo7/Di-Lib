<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KısaHikaye1.aspx.cs" Inherits="SupplierProject.KısaHikaye1" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">KISA HİKAYE</h1>
        </header>
        <div class="section background-white">          			 
			<div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-6 margin-m-bottom-30">
                    <asp:Image ID="imgKitapKapak" src = "img/ufak.jpg" style = "display:block; margin-left: auto; margin-right: auto;" runat="server" />                         
                </div>
                <div class="s-12 m-12 l-6">  
				  <h2>Ufak Tefek Olaylar</h2>
				  <h2>Daniil Kharms</h2>
                  <p>
                  "İşten çıkan adam eve dönerken yolda bir dilim Polonya ekmeği almış olan bir başka adama rastlar. Bununla ilgili bütün anlatacaklarım bu kadar."<br/>
                  " Ne gözleri ne de kulakları olan kızıl saçlı bir adam vardı. Ne de hiç saçı olduğundan ona kuramsal olarak kızıl saçlı adam deniyordu. 7
                      Konuşamıyordu, ağzı yoktu çünkü.
                      Burnu da yoktu. Kolları ya da bacakları bile yoktu. Midesi yoktu, sırtı yoktu, omurgası yoktu, iç organları falan da yoktu.
                      Hiçbir şeyi yoktu! Bu yüzden kimin hakkında konuştuğumuzu bile bilmiyoruz.
