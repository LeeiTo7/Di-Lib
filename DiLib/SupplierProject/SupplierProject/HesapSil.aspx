<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HesapSil.aspx.cs" Inherits="SupplierProject.HesapSil" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Hesabı Sil</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">  
			...
			<div class="text-center p-t-136">
                <asp:Button ID="btnEvet" class="btn btn-outline-success" href="#" runat="server" Text="Evet" OnClick="btnEvet_Click" /> 
