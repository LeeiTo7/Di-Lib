<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="İletişim.aspx.cs" Inherits="SupplierProject.İletişim" %>
            ...
            <div class="margin">
              ...
              <div class="s-12 m-12 l-6">  
						 ...
						 <div class="text-center p-t-136">
                             <asp:Button ID="btnGönder" class="btn btn-outline-success" runat="server" Text="GÖNDER" OnClick="btnGönder_Click" />						
						 </div>
                      <div class="text-center p-t-136">
                          <asp:Label ID="lblAlert" href="İletişim.aspx" runat="server" Text=""></asp:Label>
                      </div>                 
				</div>
            </div>  
          </div> 
