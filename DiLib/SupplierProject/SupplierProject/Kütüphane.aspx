<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kütüphane.aspx.cs" Inherits="SupplierProject.Kütüphane" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-1100 text-thin text-line-height-1">Kütüphane</h1>
        </header>
              ...
              <div class="margin">
                ...
                <div class="s-12 m-12 l-6">  
				 ...
				 <div class="text-right p-t-136">
                    <asp:Button ID="btnOkuma" class="btn btn-outline-success" href="#" runat="server" Text="Okumaya Devam Et" /> 
                    <asp:Button ID="btnHikayeSil" class="btn btn-outline-success" href="#" runat="server" Text="Hikayeyi Sil" />
				 </div>
                </div>
              </div>  
            </div>			 			            			                         
