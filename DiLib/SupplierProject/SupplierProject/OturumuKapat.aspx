<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OturumuKapat.aspx.cs" Inherits="SupplierProject.OturumuKapat" %>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Oturumu Kapat</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">  
			<p class="margin-bottom-30 text-size-20" style="text-align:center;">
				Oturumu Kapatmak İstediğinize Emin misiniz?
            </p>
			<div class="text-center p-t-136">
                <asp:Button ID="btnEvet" class="btn btn-outline-success" href="Default.aspx" runat="server" Text="Evet" OnClick="btnEvet_Click" /> 
                <asp:Button ID="btnHayır" class="btn btn-outline-success" href="HesapSil.aspx" runat="server" Text="Hayır" OnClick="btnHayır_Click" /> 
			</div>						
          </div>
        </div> 
      </article>
