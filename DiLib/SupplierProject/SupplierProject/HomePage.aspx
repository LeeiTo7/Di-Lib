<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="SupplierProject.HomePage" %>
        ...
        <div class="line">
          <div class="margin">
            <div class="s-12 m-12 l-4 margin-m-bottom">
              ...
              <a class="text-more-info text-primary-hover" href="Hakkımızda1.aspx">Daha Fazla Oku</a>               
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              ...
              <a class="text-more-info text-primary-hover" href="ÖrnekHikaye1.aspx">Daha Fazla Oku</a>                
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              ...
              <a class="text-more-info text-primary-hover" href="ÖnGösterim1.aspx">Daha Fazla Oku</a>                
            </div>
          </div>
        </div>
      </section>     
